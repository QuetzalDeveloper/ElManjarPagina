...
<!-- Fin de caruusel de imagenes-->		
       ...
       <div class="row mb-5">
          ...
          <div class="media-boxes">  			  
		    <div class="media">
              <div class="media-body tm-bg-image">
				<img src="imagenes/otras/rv1.jpg" width="100" height="100" alt="Image" class="mr-3">
                <div class="tm-description-box">
                  <h5 class="tm-text-white">Niño (menores de 10 años) y algo mas</h5>
                  <p class="mb-0 tm-text-white">$888.88</p>
                </div>
              </div>
            </div>
		...
		<div class="media">
			<div class="media-body tm-bg-image">
				<div class="tm-description-box">
					<p class="tm-text-white">Adulto</p>
				</div>
			</div>
			<div class="tm-buy-box">
				<a href="menu.php" class="tm-bg-gold tm-text-white tm-buy" >$ 250</a>
			</div>
        </div>
        ...
        <div class="media-body tm-bg-image">
        <div class="tm-description-box">
        <p class="tm-text-white">Niño (menores de 10 años)</p>
        </div>
        </div>
		<div class="tm-buy-box">
        <a href="menu.php" class="tm-bg-gold tm-text-white tm-buy" >$ 200</a>
        </div>
        </div>
...
if($filas > 0){
	for($x = 0; $x < $filas; $x++){
        ...
        <div class="media-body tm-bg-image">
        <div class="tm-description-box">
        <p class="tm-text-white">'.$registro->nombre.'</p>
        </div>
        </div>
		<div class="tm-buy-box">
        <a href="menu.php?iden='.$registro->id.'" class="tm-bg-gold tm-text-white tm-buy" >$ '.$registro->precio.'</a>
        </div>
        </div>');
